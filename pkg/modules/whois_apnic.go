...
// WhoisAPNICModule processes APNIC WHOIS database dumps
type WhoisAPNICModule struct {
	storage *pkg.Storage
	baseURL string
	parser  *rpsl.Parser
}

// NewWhoisAPNIC creates a new APNIC WHOIS module
func NewWhoisAPNIC(storage *pkg.Storage) *WhoisAPNICModule {
	return &WhoisAPNICModule{
		storage: storage,
		baseURL: "https://ftp.apnic.net/apnic/whois",
		parser:  rpsl.NewParser(),
	}
}

func (m *WhoisAPNICModule) Name() string {
	return "whois-apnic"
}

func (m *WhoisAPNICModule) Schedule() pkg.Schedule {
	return pkg.Schedule{
...
func (m *WhoisAPNICModule) Process(ctx context.Context) error {
	url := fmt.Sprintf("%s/apnic.db.inetnum.gz", m.baseURL)
...
func (m *WhoisAPNICModule) parseAndStore(ctx context.Context, reader *gzip.Reader) error {
...
func (m *WhoisAPNICModule) convertInetnum(obj *rpsl.Object) (pkg.InetnumData, error) {
	// Extract range
	...
	// APNIC uses last-modified field
...
func (m *WhoisAPNICModule) convertAutNum(obj *rpsl.Object) (pkg.AutNumData, error) {
	// Extract ASN
